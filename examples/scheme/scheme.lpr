...
procedure cb6(w: PFl_Widget; data: Pointer); cdecl;
var
  r,g,b: Byte;
begin
  r := 0;
...
begin
  ...
  b5 := Fl_Button_new(50, 225, 300, 40, 'Scheme: oxy');
  b6 := Fl_Button_new(50, 275, 300, 40, 'Background color');
  Fl_Window_end(w);
  Fl_Window_show(w);
  ...
  Fl_Radio_Button_set_callback(b6, @cb6, nil);
  Result := Fl_run();
end;
